...
TOKEN = '7267665848:AAENXqVW97ZUPiCo_GwnGN5VYnPIOt2Rg44'
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/c/2056835537/103*", parse_mode='Markdown')
        ...
        bot.reply_to(message, "*Help selected @RohitRWA0*", parse_mode='Markdown')
    elif message.text == "Contact admin✔️":
        bot.reply_to(message, "*Contact admin selected @RohitRWA0*", parse_mode='Markdown')
    else:
